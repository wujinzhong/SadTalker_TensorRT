...
class OcclusionAwareGenerator(nn.Module):
    ...
    def __init__(self, image_channel, feature_channel, num_kp, block_expansion, max_features, num_down_blocks, reshape_channel, reshape_depth,
        ...
        print(f"dense_motion_params: {dense_motion_params}")
    ...
    def forward(self, source_image, kp_driving, kp_source):
        ...
        if self.dense_motion_network is not None:
            assert 'jacobian' not in kp_driving
...
class OcclusionAwareSPADEGenerator(nn.Module):
    ...
    def forward(self, source_image, kp_driving_value, kp_source_value):
        ...
        output_dict = {}
        if self.dense_motion_network is not None:
            dense_motion = self.dense_motion_network(feature=feature_3d, kp_driving_value=kp_driving_value,
        ...
        return output_dict["mask"], output_dict["occlusion_map"], output_dict["prediction"]
        #return output_dict